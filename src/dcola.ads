...
--------------------------------------------------------------------------------
   ...
   --declaració del porcediment cvacia. Duu a terme la inicialització de la
   ...
   --declaració del procediment borar_primero. Elimina l'element que es troba 
   --apuntat perl punter q de la coa passada per paràmetre.
   procedure borrar_primero(qu: in out cola);
   --declaració de la funció coger_primero. Retorna l'element apuntat perl
   ...
   --declaración función is_last_item. Lleva a cabo la verificación de si la
   --cola dada está formada por un solo elemento.
